...
Other maybe useful variables
@r5 + 00h = A Offset
@r5 + 04h = Scene ID
@r5 + 08h = Huffman Code Offset
@r5 + 0Ch = Start of the D block
@r5 + 10h = Start of the E block
@r5 + 14h = zero (probably)

; Start of the outer if/else loop
...
|  |  8001D510 34170020 mov   r23,20h           ; r23 = r23 + 0x0020
